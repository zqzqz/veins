...
Define_Module(veins::RSUAuctionApp);

void RSUAuctionApp::initialize(int stage) {
...
void RSUAuctionApp::handleSelfMsg(cMessage* msg) {

}

void RSUAuctionApp::onWSM(BaseFrame1609_4* wsm) {
